...
export class Annotation {
    ...
    toGeoJson() {
        ...
        if (geoJson) {
            ...
            properties.initOptions = Object.assign({ id: this.id, annotationType: this.annotationType, liveUpdate: this.liveUpdate, userInteractive: this.userInteractive, entityProperties: this.entityProperties, handleType: this.handleType, handleProperties: this.handleProperties, groupRecords: this.groupsToRecords(), attributes: this.attributes, bypassTerrainSampleOnDrag: this.bypassTerrainSampleOnDrags }, properties.initOptions);
        }
        return geoJson;
    }
    toWkt() {
